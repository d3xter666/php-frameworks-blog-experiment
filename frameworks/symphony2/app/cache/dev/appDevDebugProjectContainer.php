...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'frameworks_experiment', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_157a5ed281c16a9cb030030c629308fb45b66462407a21bd000096d8282f02a6');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_157a5ed281c16a9cb030030c629308fb45b66462407a21bd000096d8282f02a6');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_157a5ed281c16a9cb030030c629308fb45b66462407a21bd000096d8282f02a6');
        ...
        $d->setProxyDir('C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\dev-tools\\web_root\\own-works\\php-frameworks-blog-experiment\\frameworks\\symphony2\\vendor\\Symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\dev-tools\\web_root\\own-works\\php-frameworks-blog-experiment\\frameworks\\symphony2\\vendor\\Symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\dev-tools\\web_root\\own-works\\php-frameworks-blog-experiment\\frameworks\\symphony2\\vendor\\Symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\dev-tools\\web_root\\own-works\\php-frameworks-blog-experiment\\frameworks\\symphony2\\vendor\\Symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\dev-tools\\web_root\\own-works\\php-frameworks-blog-experiment\\frameworks\\symphony2\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\dev-tools\\web_root\\own-works\\php-frameworks-blog-experiment\\frameworks\\symphony2\\src\\Experiments\\BlogBundle/Resources/views', 'ExperimentsBlog');
        $instance->addPath('C:\\dev-tools\\web_root\\own-works\\php-frameworks-blog-experiment\\frameworks\\symphony2\\src\\Acme\\DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('C:\\dev-tools\\web_root\\own-works\\php-frameworks-blog-experiment\\frameworks\\symphony2\\vendor\\Symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\dev-tools\\web_root\\own-works\\php-frameworks-blog-experiment\\frameworks\\symphony2\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app/Resources/views');
        $instance->addPath('C:\\dev-tools\\web_root\\own-works\\php-frameworks-blog-experiment\\frameworks\\symphony2\\vendor\\Symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('5ab0e42b108429fa6a9daf994f1fbe239');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'C:\\dev-tools\\web_root\\own-works\\php-frameworks-blog-experiment\\frameworks\\symphony2\\vendor\\Symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app/cache/dev',
            'kernel.logs_dir' => 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app/logs',
            'kernel.bundles' => array(
                ...
                'ExperimentsBlogBundle' => 'Experiments\\BlogBundle\\ExperimentsBlogBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'frameworks_experiment',
            'database_user' => 'root',
            ...
            'locale' => 'en',
            'secret' => '5ab0e42b108429fa6a9daf994f1fbe239',
            'database_path' => NULL,
            ...
            'debug.container.dump' => 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'kernel.secret' => '5ab0e42b108429fa6a9daf994f1fbe239',
            ...
            'session.save_path' => 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\dev-tools\\web_root\\own-works\\php-frameworks-blog-experiment\\frameworks\\symphony2\\vendor\\Symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app/../web',
            'assetic.write_to' => 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/app/cache/dev/doctrine/orm/Proxies',

...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/vendor/Symfony/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/vendor/Symfony/app/cache/prod/assetic/config'), false)));
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/vendor/Symfony/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
        return $instance;
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/vendor/Symfony/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_308de3148e5d39465fef8ba7e16036ddc0bd96fe48217faa4a1f8d2f9920e2da');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_308de3148e5d39465fef8ba7e16036ddc0bd96fe48217faa4a1f8d2f9920e2da');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_308de3148e5d39465fef8ba7e16036ddc0bd96fe48217faa4a1f8d2f9920e2da');
        ...
        $d->setProxyDir('C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/vendor/Symfony/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/vendor/Symfony/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/vendor/Symfony/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/vendor/Symfony/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/vendor/Symfony/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/vendor/Symfony/app', 'UTF-8');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\dev-tools\\web_root\\own-works\\php-frameworks-blog-experiment\\frameworks\\symphony2\\vendor\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\dev-tools\\web_root\\own-works\\php-frameworks-blog-experiment\\frameworks\\symphony2\\vendor\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\dev-tools\\web_root\\own-works\\php-frameworks-blog-experiment\\frameworks\\symphony2\\vendor\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\dev-tools\\web_root\\own-works\\php-frameworks-blog-experiment\\frameworks\\symphony2\\vendor\\Symfony\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\dev-tools\\web_root\\own-works\\php-frameworks-blog-experiment\\frameworks\\symphony2\\vendor\\Symfony\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/vendor/Symfony/app/Resources/views');
        $instance->addPath('C:\\dev-tools\\web_root\\own-works\\php-frameworks-blog-experiment\\frameworks\\symphony2\\vendor\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
        return $instance;
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/vendor/Symfony/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/vendor/Symfony/app/cache/prod');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/vendor/Symfony/app',
            'kernel.environment' => 'prod',
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/vendor/Symfony/app/cache/prod',
            'kernel.logs_dir' => 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/vendor/Symfony/app/logs',
            ...
            'session.save_path' => 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/vendor/Symfony/app/cache/prod/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\dev-tools\\web_root\\own-works\\php-frameworks-blog-experiment\\frameworks\\symphony2\\vendor\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'router.resource' => 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/vendor/Symfony/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/vendor/Symfony/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/vendor/Symfony/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/vendor/Symfony/app/cache/prod/assetic',
            ...
            'assetic.read_from' => 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/vendor/Symfony/app/../web',
            'assetic.write_to' => 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/vendor/Symfony/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/dev-tools/web_root/own-works/php-frameworks-blog-experiment/frameworks/symphony2/vendor/Symfony/app/cache/prod/doctrine/orm/Proxies',
